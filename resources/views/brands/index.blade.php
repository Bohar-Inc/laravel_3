                ...
                <div class="col-lg-6">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body">
                            ...
                            <a href="{{route('brands.create')}}" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i>Add Brand</a>
                                    ...
                                    @foreach($brands as $key=> $brand)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form id="brand-delete-{{$brand->id}}" method="post" action="{{route('brands.destroy',$brand->id)}}">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
